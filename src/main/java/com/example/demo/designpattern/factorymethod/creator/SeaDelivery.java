...
@Component
@LogisticQualifier(LogisticType.SEA)
public class SeaDelivery extends Logistics{
    private final Transport transport;

    @Autowired
    public SeaDelivery(@TransportQualifier(TransportType.SHIP) Transport transport) {
